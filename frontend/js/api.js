...
function getToken() { return localStorage.getItem('ccf_token'); }
...
function getUser() {
  try { return JSON.parse(localStorage.getItem('ccf_user')); } catch { return null; }
}
...
const api = {
  ...
  trackComplaint: (ref) => apiFetch(`/complaints/track/${encodeURIComponent(ref)}`),
